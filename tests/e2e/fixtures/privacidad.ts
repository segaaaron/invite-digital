...
export async function seedPrivateEvent(slug: string): Promise<{ eventId: string; token: string }> {
...
export async function deletePrivateEvent(slug: string): Promise<void> {
