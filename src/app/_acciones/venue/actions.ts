...
import type { TableShape } from '@/modules/venue/domain/venue-table'
import type { ZoneKind } from '@/modules/venue/domain/venue-zone'
import type { ElementMove } from '@/modules/venue/application/move-element'
