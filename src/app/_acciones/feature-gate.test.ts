...
import { plansError } from '@/modules/plans/domain/errors'
...
vi.mock('@/app/_acciones/events/actions', () => ({ eventUnlocked: async () => true }))
...
describe('mesas (venue)', () => {
  it('con el salón incluido la acción funciona', async () => {
    permitida()
    const { addTableAction } = await import('@/app/_acciones/venue/actions')
  ...
  it('la comprobación va después de la sesión, no en vez de ella', async () => {
    noIncluida()
    const { assignGroupAction } = await import('@/app/_acciones/venue/actions')
...
describe('mesa de regalos (registry)', () => {
  it('con la mesa de regalos incluida la acción funciona', async () => {
    permitida()
    const { addGiftAction } = await import('@/app/_acciones/registry/actions')
  ...
  it('los fondos van por la misma puerta que los regalos', async () => {
    noIncluida()
    const { addFundAction } = await import('@/app/_acciones/registry/actions')
...
describe('modo puerta (checkin)', () => {
  it('con el modo puerta incluido la acción funciona', async () => {
    permitida()
    const { checkInByGroupAction } = await import('@/app/_acciones/checkin/actions')
...
describe('mesa de regalos · lado del invitado', () => {
  ...
  it('liberar también se rechaza: devolvería el regalo a un catálogo cerrado', async () => {
    noIncluida()
    const { releaseGiftAction } = await import('@/app/_acciones/registry/actions')
