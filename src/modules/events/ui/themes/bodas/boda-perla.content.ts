...
/**
 * El contenido de muestra de «Marco Perlado», copiado de su maqueta
 * (`wedding-variants-8.jsx`): la boda de Emma & Gael.
 */
export const CONTENIDO_DE_MUESTRA: InvitationContent = {
  hero: { eyebrow: 'Nuestra Boda', nameA: 'Emma', nameB: 'Gael', serial: '· NOS CASAMOS · 20.09.2026 ·' },
  ...
  dressCode: {
    ...
    colors: ['#1a1a1a', '#d4b678', '#c8b8a0', '#7a8c64', '#f1ede4'],
  },
  notes: [
    {
      title: 'Nuestra historia',
      text: 'Fue en una librería de viejo, una tarde de septiembre. Emma buscaba a Borges. Gael tropezó con su pila de libros. Se cayeron tres tomos y un cuaderno de notas con dibujos. Lo demás, como suele decirse, es historia. Siete años más tarde, Emma escribe poemas. Gael sigue dibujando. Y ambos firman la suya, en septiembre, igual que la primera vez.',
    },
    {
  ...
  music: { track: 'Nuestra canción', artist: 'Emma & Gael' },
  closing: { text: 'Te esperamos.', signature: 'Emma & Gael' },
}
