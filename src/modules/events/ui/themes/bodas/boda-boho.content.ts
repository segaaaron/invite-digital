...
/**
 * El contenido de muestra de «Pampas y Flores Secas», copiado de su maqueta
 * (`wedding-variants-10.jsx`): la boda de Sara & Óscar.
 */
export const CONTENIDO_DE_MUESTRA: InvitationContent = {
  hero: { eyebrow: 'Nuestra Boda', nameA: 'Sara', nameB: 'Óscar', serial: '· NOS CASAMOS · 20.09.2026 ·' },
  ...
  dressCode: {
    ...
    colors: ['#8c6a4f', '#c8a876', '#e4c9a8', '#5a3e2b', '#f5ead9'],
  },
  notes: [
    {
      title: 'Nuestra historia',
      text: 'Fue en una librería de viejo, una tarde de septiembre. Sara buscaba a Borges. Óscar tropezó con su pila de libros. Se cayeron tres tomos y un cuaderno de notas con dibujos. Lo demás, como suele decirse, es historia. Siete años más tarde, Sara escribe poemas. Óscar sigue dibujando. Y ambos firman la suya, en septiembre, igual que la primera vez.',
    },
    {
  ...
  music: { track: 'Nuestra canción', artist: 'Sara & Óscar' },
  closing: { text: 'Te esperamos.', signature: 'Sara & Óscar' },
}
