...
export const es = {
  ...
  fiestas: {
    ...
    boda: {
      ...
      plannerBody: 'Los novios te suman a su evento y entras gratis con tu cuenta: plan de tareas, presupuesto con quién paga, porteros y tu mesa con todos tus eventos y lo que vence en cada uno.',
    },
    xv: {
      eyebrow: 'XV Planner',
      ...
      plannerBody: 'La quinceañera o sus padres te suman a su evento y entras gratis con tu cuenta: plan de tareas con chambelanes y vals, presupuesto con quién paga, porteros y tu mesa con todos tus eventos.',
    },
