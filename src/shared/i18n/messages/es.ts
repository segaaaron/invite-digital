  ...
  themes: {
    ...
    designs: {
      ...
      'xv-vogue': {
        coverEyebrow: 'YOUR ACCESS',
        coverHeadline: 'VIP',
        coverLabel: 'VER INVITACIÓN',
        edicion: 'ROSA PASTEL',
        numero: 'N°15',
        xv: 'XV',
        personal: 'INVITACIÓN PERSONAL',
        pases: '{n} pases asignados',
        pasesUno: '1 pase asignado',
        cronograma: 'CRONOGRAMA',
      },
      'xv-y2k': {
        coverEyebrow: 'YOUR ACCESS',
      ...
      'xv-boho': { misQuince: '· MIS QUINCE AÑOS ·', retrato: 'LA QUINCEAÑERA', faltan: 'FALTAN', cronograma: 'CRONOGRAMA' },
      'xv-min': {
        coverEyebrow: 'YOUR ACCESS',
        quince: '· QUINCE ·',
        numero: '· N° 015 ·',
      ...
      'xv-deco': {
        ...
        cronograma: 'CRONOGRAMA',
        retrato: 'RETRATO GATSBY',
      },
      'xv-princ': {
        coverEyebrow: 'ESTÁS INVITADO',
        coverHeadline: 'Algo\ninolvidable',
        coverLabel: 'MIS QUINCE AÑOS',
