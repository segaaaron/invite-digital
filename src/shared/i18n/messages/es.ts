...
export const es = {
  ...
  collections: {
    ...
    goToScene: 'Ir a la escena {n}: {nombre}',
  ...
  themes: {
    ...
    giftsEmbrace: 'Detalles que Abrazan',
    myFifteenYears: 'Mis Quince Años',
    suggestedColors: 'Colores sugeridos',
    chooseDesign: 'Elegir este diseño',
    shareImageTap: 'Toca para abrirla',
    designs: {
      'cumple-beer': {
      ...
      boda: { guestbook: 'LIBRO DE FIRMAS DIGITAL' },
      'boda-bot': {
      ...
      civil: { gifts: 'REGALO DE BODA', seal: '· UNIDOS ·', cover: 'UNIÓN CIVIL' },
      'boda-navy': {
        nuestraBoda: 'NUESTRA BODA',
        invitacion: 'Nuestro gran día se aproxima y nos encantaría que formaras parte de él.',
        reservado: 'HEMOS RESERVADO PARA TI',
      ...
      'xv-papillon': {
        ...
        misXv: 'MIS XV AÑOS',
        itinerario: 'Itinerario',
        confirmar: 'Confirma tu Asistencia',
      },
    },
  },
  invitation: {
    error: {
      ...
      body: 'Vuelve a intentarlo en un momento. Si sigue sin abrirse, escríbenos y te confirmamos a mano.',
  ...
  registry: {
    ...
    sobresDefault: 'Si deseas tener un detalle con nosotros, el día de la fiesta habrá una caja para tu sobre.',
    transferTitle: 'Transferencia',
    transferIntro: 'Si prefieres, puedes hacerlo por transferencia o escaneando el QR desde la app de tu banco.',
    bank: 'Banco',
    holder: 'Titular',
    account: 'Cuenta',
    copy: 'Copiar',
    copied: 'Copiado',
    qrAlt: 'Código QR para transferir',
    qrHint: 'Escanéalo desde la app de cualquier banco',
  ...
  orders: {
    ...
    form: {
      ...
      eventDate: 'Fecha del evento (si ya la tienes)',
      notes: 'Cuéntanos lo que tienes en mente',
      submit: 'Registrar pedido',
      submitting: 'Registrando…',
      successTitle: 'Pedido registrado',
      successText: 'Tu referencia es {ref}. Guárdala: con ella subes el comprobante y sigues el estado de tu pedido.',
      goPay: 'Ir a pagar',
      proofLabel: 'Comprobante de la transferencia',
      proofHint: 'Una foto o un PDF, hasta {mb} MB',
      proofReceived: 'Comprobante recibido. Lo revisamos y te avisamos por WhatsApp.',
      proofSubmit: 'Enviar comprobante',
      proofSubmitting: 'Subiendo…',
      errors: {
        rateLimited: 'Demasiados pedidos seguidos. Espera un minuto e inténtalo otra vez.',
        failed: 'No pudimos registrar el pedido. Inténtalo en un momento.',
        name: 'El nombre es obligatorio y no puede pasar de 160 caracteres.',
        contact: 'Hace falta un contacto: WhatsApp o correo.',
        plan: 'Falta el plan.',
        notes: 'Las notas no pueden pasar de 1000 caracteres.',
        invalid: 'Revisa los datos del pedido.',
        proofRateLimited: 'Demasiados intentos seguidos. Espera un minuto.',
        proofMissing: 'Falta el archivo del comprobante.',
        proofEmpty: 'El archivo está vacío.',
        proofTooBig: 'El archivo pasa de {mb} MB.',
        proofType: 'Solo aceptamos una foto (JPG, PNG o WEBP) o un PDF.',
        proofRejected: 'No pudimos aceptar ese archivo.',
        proofApproved: 'Este pedido ya está aprobado: no hace falta otro comprobante.',
        proofFailed: 'No pudimos guardar el comprobante. Inténtalo en un momento.',
      },
    },
  },
  seo: {
