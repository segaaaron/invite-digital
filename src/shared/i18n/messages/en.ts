  ...
  themes: {
    ...
    designs: {
      ...
      'xv-eleg': {
        ...
        festejar: 'to celebrate my',
        xvMayus: 'FIFTEENTH',
        faltan: 'COUNTDOWN',
        granDia: 'The Big Day',
        verUbicacion: 'VIEW LOCATION',
        itinerario: 'Schedule',
        deActividades: 'of events',
        vestimenta: 'Dress code',
        confirmar: 'Confirm attendance',
        porFavor: 'Please confirm your attendance',
        dias: 'MON,TUE,WED,THU,FRI,SAT,SUN',
      },
      'xv-vogue': {
        coverEyebrow: 'YOUR ACCESS',
        coverHeadline: 'VIP',
        coverLabel: 'VIEW INVITATION',
        edicion: 'PASTEL PINK',
        numero: 'N°15',
        xv: 'XV',
        personal: 'PERSONAL INVITATION',
        pases: '{n} passes assigned',
        pasesUno: '1 pass assigned',
        cronograma: 'SCHEDULE',
      },
      'xv-y2k': {
        coverEyebrow: 'YOUR ACCESS',
        coverHeadline: 'VIP',
        coverLabel: 'ENTER THE GALAXY',
        galaxia: '· Y2K · GALAXY ·',
        sistema: 'SYS · 15.0',
        xv: 'XV',
        misXv: 'MY XV',
      ...
      'xv-boho': { misQuince: '· MY FIFTEENTH ·', retrato: 'THE BIRTHDAY GIRL', faltan: 'COUNTDOWN', cronograma: 'SCHEDULE' },
      'xv-min': {
        coverEyebrow: 'YOUR ACCESS',
        quince: '· FIFTEEN ·',
        numero: '· N° 015 ·',
        ...
        eventos: 'P.01 — EVENTS',
        lugar: 'P.02 — VENUE',
        vestimenta: 'P.03 — DRESS CODE',
        rsvp: 'P.04 — RSVP',
        confirma: 'RSVP',
        antes: 'by',
        del: '',
        mesa: '// DIGITAL REGISTRY',
      },
      'xv-papillon': {
        xvAnos: 'XV YEARS',
        padrinos: '& MY GODPARENTS',
      ...
      'xv-deco': {
        ...
        cuenta: 'COUNTDOWN',
        cronograma: 'SCHEDULE',
        retrato: 'GATSBY PORTRAIT',
      },
      'xv-princ': {
        coverEyebrow: 'YOU ARE INVITED',
        coverHeadline: 'Something\nunforgettable',
        coverLabel: 'MY FIFTEENTH',
        lema: '· PRINCESS · FOR A DAY ·',
        cumple: 'turns',
        xv: 'XV',
        anios: 'years',
        retrato: 'THE BIRTHDAY GIRL',
        faltan: 'COUNTDOWN',
        padrinos: 'Waltz Godparents',
        vestimenta: 'DRESS CODE',
      },
      'xv-realeza': {
        coverEyebrow: 'YOU ARE INVITED',
        ...
        mis: 'My',
        xvAnos: 'Fifteenth',
        lema: '· CRYSTAL ROYALTY ·',
        firma: 'ROYALTY · CRYSTAL',
        personal: 'PERSONAL INVITATION',
        pases: '{n} passes assigned',
        pasesUno: '1 pass assigned',
        faltan: 'COUNTDOWN',
